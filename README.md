...
nSAVE Blocker is an extension of nSAVE that prevents FODSOFT™ sites from being saved or loaded from external and/or unauthorized locations. It can be recognized by displaying the icon (<img src="images/icono_nsave_blocker.png" width="24" height="auto">) when active.
